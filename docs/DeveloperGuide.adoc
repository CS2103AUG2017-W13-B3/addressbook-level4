...
|`* * *` |user |find people by their tags|view people under certain tags
...
|`* *` |user |click on the address to be shown its Google Maps result|easily navigate to my contact's location

|`* *` |user |resize the dimensions of the command and output bar|customise the application to my desired layout
...
|`* *` |user |have a Notes section to add notes that can be tagged and shared with people|jot down certain events and details
