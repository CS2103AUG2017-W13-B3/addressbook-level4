...
Figure 3.1.2 shows a sequence diagram of how the `BackupCommand` is carried out.
...
....
An API provided by Google for client applications to perform basic Create, Read, Update and Delete(CRUD) functions on a user's contacts.
....
[appendix]
== Product Survey
